...
# solution has %w(y n) which creates an array with ['y, 'n'], it then uses the
# Array#include? to check if the answer is in that array. Cool. It pulls out
# the something message, which makes sense, but mine works too.
